                                ...
                                <div class="my-account-content col-xl-9 col-lg-9 col-md-12 d-inline-block">
                                    ...
                                    <form id="update-data">
                                        ...
                                        <p class="form-row w-50 float-start p-2 pt-0">
                                            ...
                                            <input autocomplete="off" type="text" name="account-first-name" id="account-first-name" class="w-100" value="<?php echo e(Session::get('user')->getFirstName() ? Session::get('user')->getFirstName() : ''); ?>">
                                        </p>
                                        <p class="form-row w-50 float-start p-2 pt-0">
                                            ...
                                            <input autocomplete="off" type="text" name="account-second-name" id="account-second-name" class="w-100" value="<?php echo e(Session::get('user')->getSecondName() ? Session::get('user')->getSecondName() : ''); ?>">
                                        </p>
                                        <p class="form-row w-100 p-2 pt-0">
                                            ...
                                            <input autocomplete="off" type="text" name="account-username" id="account-username" class="w-100 mb-0 pb-0" value="<?php echo e(Session::get('user')->getUsername() ? Session::get('user')->getUsername() : ''); ?>">
                                        ...
                                        <p class="form-row w-100 p-2 pt-0">
                                            ...
                                            <input autocomplete="off" style="opacity: 0.7;" disabled type="text" name="account-email" id="account-email" class="w-100 mb-0 pb-0" value="<?php echo e(Session::get('user')->getEmail() ? Session::get('user')->getEmail() : ''); ?>">
                                        </p>
    ...
    <script>
        document.getElementById('update-data').addEventListener('submit', function(event){
            ...
            if(firstName == ''){
                ...
                $.ajax({
                    method: 'POST',
                    url: "<?php echo e(route('updateMyData')); ?>",
                    data: formData,
...
</html><?php /**PATH C:\Users\djord\OneDrive\Documents\Laravel\polovnitelefoni\resources\views/edit-account.blade.php ENDPATH**/ ?>