                            ...
                            <div class="module-wrapper">
                                <div class="banner bg-light align-center price-banner">
                                    ...
                                    <div class="banner-image">
                                        <img src="<?php echo e(asset('images/banner-phone.jpg')); ?>" alt="" srcset="">
                                    </div>
                    ...
                    <div class="site-module banner-module">
                            <div class="module-wrapper">
                                <div class="banner bg-light align-center price-banner">
                                    ...
                                    <div class="banner-image">
                                        <img src="<?php echo e(asset('images/banner-headphones.jpg')); ?>" alt="" srcset="">
                                    </div>
                                    <a href="" class="overlay-link"></a>
                                </div>
                            </div>
                    ...
                    <div class="site-module banner-module">
                            <div class="module-wrapper">
                                <div class="banner bg-light align-center price-banner">
                                    ...
                                    <div class="banner-image">
                                        <img src="<?php echo e(asset('images/banner-addons.jpg')); ?>" alt="" srcset="">
                                    </div>
                                    <a href="" class="overlay-link"></a>
                                </div>
                            </div>
                        ...
                        <div class="site-scroll ps overflow-hidden">
                            <div class="sidebar-inner">
                                ...
                                <div class="widget widget-media-image">
                                    <img src="<?php echo e(asset('images/widget-banner.jpg')); ?>" 
                                        alt="" 
...
<script src="<?php echo e(asset('js/ads-widget.js')); ?>"></script>
<script>
...
<script>
    $(document).ready(function() {
        $(".hover-slider-toggle-panel").hover(
            ...
            function() {
                var defaultImageUrl = "<?php echo e(asset('images/iPhone 14 Pro Max.png')); ?>";
                var productCard = $(this).closest(".product-card");
                var mainImage = productCard.find(".main-image");
...
</script><?php /**PATH C:\Users\djord\OneDrive\Documents\Laravel\polovnitelefoni\resources\views/welcome.blade.php ENDPATH**/ ?>