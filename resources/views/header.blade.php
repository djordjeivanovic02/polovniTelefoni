  ...
  <div class="container">
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav pt-2 pb-2">
        ...
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center" href="{{route('my-account')}}">Moj nalog</a>
        </li>
        <li class="nav-item">
...
">
  <div class="container">
      <a class="navbar-brand" href="/"><img src="{{ asset('images/logo.png') }}" alt="Logo" class='navbar-logo'></a>
      ...
      <div class="navbar-nav d-flex align-items-center">
        <div class="row w-100 m-0">
          <a class="nav-link d-inline-block col-3 m-0" href="{{ route('my-account') }}">
            <img src="{{ asset('images/no-user.png') }}" alt="Prijavi se" style="width: 30px"> 
          </a>
          <div class="d-inline-block col-8 m-0" style="cursor: pointer" onclick="window.location.href = '/my-account/dashboard'">
            <p style="font-size: 12px; margin-bottom: 0">
              {{ Session::get('user') ? Session::get('user')->getUsername() ? 'Dobrodosli' : 'Prijavi se' : 'Prijavi se na' }}
            </p>
            <p style="font-size: 14px; font-weight: bold; margin-bottom: 0">
              {{ Session::get('user') ? Session::get('user')->getUsername() ? Session::get('user')->getUsername() : 'Profil' : 'Profil' }}
            </p>
          </div>
        </div>
      </div>
      <div class="navbar-nav">
          <a class="nav-link" href="#">
            <img src="{{ asset('images/heart.png') }}" alt="Prijavi se" style="width: 30px"> 
          </a>
          <div class="row w-100 m-0">
            <a class="nav-link d-inline-block col-4 m-0" href="#">
              <img src="{{ asset('images/shop-bag.png') }}" alt="Prijavi se" style="width: 30px"> 
            </a>
...
<nav class="navbar navbar-light d-xxl-none d-xl-none d-lg-block d-md-block d-sm-block d-xs-block d-block p-0">
    <div class="container-fluid hamburger pt-2 pb-2">
        <button onclick="openMobileMenu()" class="navbar-toggler open-phone-menu" type="button" data-toggle="collapse" data-target="#navbarToggleExternalContent2" aria-controls="navbarToggleExternalContent1" aria-expanded="false" aria-label="Toggle navigation">
            <img src="{{ asset('images/hamburger-navbar.png') }}" alt="">
        </button>
        <img src="{{ asset('images/logo.png') }}" alt="" style="width: 90%; max-width: 150px">
        <img src="{{ asset('images/shop-bag.png') }}" alt="Prijavi se" style="width: 30px"> 
    </div>
    <hr class="mt-0">
</nav>
<div class="phone-menu-background" onclick="closeMobileMenu()">
  <div class="phone-menu" id='phone-menu'>
    <div class="container">
      <div class="row d-flex align-items-center">
        <img src="{{ asset('images/logo.png') }}" alt="logo" class="col-10 ">
        <img src="{{ asset('images/close.png') }}" alt="close" class="col-2" style="height: 30px" onclick="closeMobileMenu()">
      </div>
    </div>
      ...
      <ul class="navbar-nav mt-2 bg-light mb-3">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle d-flex align-items-center w-75 m-auto" href="#">
              <img class="d-inline-block" src="{{ asset('images/hamburger-navbar.png') }}" alt="" style="width: 20px;">
          ...
          <ul class="dropend dropdown-menu rounded-0 w-100 m-0 p-0">
            <li class="pt-2 pb-2 pl-0">
              <a class="dropdown-toggle" href="" onclick="showMobilePhones()" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="d-inline-block" src="{{ asset('images/mobile-phone-icon.png') }}" alt="">
                Mobilni Telefoni
              </a>
            </li>
            <hr class="dropdown-divider">
            <li class="p-2">
              <img class="d-inline-block" src="{{ asset('images/headphones.png') }}" alt="">
              <a class="d-inline-block" href="#">Slusalice</a>
            </li>
            <hr class="dropdown-divider">
            <li class="p-2">
              <img class="d-inline-block" src="{{ asset('images/charger.png') }}" alt="">
              <a class="d-inline-block" href="#">Punjaci</a>
            </li>
            <hr class="dropdown-divider">
            <li class="p-2">
              <img class="d-inline-block" src="{{ asset('images/tablet.png') }}" alt="">
    ...
    <div class="container mt-3 mb-3">
      <ul class="list-unstyled dropend">
        ...
        <li class="nav-item p-2">
          <a class="nav-link d-flex align-items-center" href="">
            <img class="d-inline-block" src="{{ asset('images/mobile-phone-icon.png') }}" alt="phone" style="width: 30px; margin-right: 10px">
            Prodaja Telefona
          </a>
        </li>
        <li class="nav-item p-2">
          <a class="nav-link d-flex align-items-center" href="">
            <img class="d-inline-block" src="{{ asset('images/headphones.png') }}" alt="phone" style="width: 30px; margin-right: 10px">
            Slusalice
          </a>
        </li>
        <li class="nav-item p-2">
      ...
      <ul class="list-unstyled">
        ...
        <li class="nav-item p-2">
          <a class="nav-link d-flex align-items-center" href="">
            <img class="d-inline-block" src="{{ asset('images/no-user.png') }}" alt="phone" style="width: 30px; margin-right: 10px">
            Moj nalog
          </a>
        </li>
  ...
  <div class="category-mobile-phones" id="category-mobile-phones">
    <div class="container m-3">
      <img src="{{ asset('images/back-icon.png') }}" alt="back-icon" style="width: 25px" onclick="closeMobilePhones()">
        ...
        <div class="bg-light" style="width: 250px">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-black d-inline-block m-1" href="#" id="categoryDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="d-inline-block" src="{{ asset('images/hamburger-navbar.png') }}" alt="" srcset="" style="width: 20px; margin-left: 10px; margin-right: 10px;">
              Sve Kategorije
            </a>
    ...
    <div class="navbar-nav">
      <li class="nav-item dropdown">
        <div class="d-flex align-items-center">
          <img src="{{ asset('images/discount.png') }}" alt="" class="d-inline-block" style="width: 25px; margin-right: 5px;">
